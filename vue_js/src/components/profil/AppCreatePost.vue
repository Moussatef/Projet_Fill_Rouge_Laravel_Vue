<template>
  <div class="w-full shadow-fb  bg-white p-4 rounded-lg py-4 border-l-2 border-r-2 border-blue-400">
    ...
    <div class="border border-gray-900 border-opacity-20 mt-2" />
      ...
      <button
        class="flex justify-center items-center w-1/3 focus:outline-none mx-auto mt-2 py-1"
      >
        <!-- <Image /> --><svg
        class="h-6 w-6"
          height="511pt"
        ...
        <span class="text-gray-900 text-opacity-50 font-medium ml-2">
          Photo/Video
        </span>
      </button>
    </div>
