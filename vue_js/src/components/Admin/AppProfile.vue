<template>
  <div v-if="admin_info">
    <div class="w-3/5 mt-10 mx-auto bg-white border rounded-lg m-1 shadow-lg ">
      <div class="flex">
      ...
      <div class="flex">
        <label class="m-3 w-40 text-left"
        >Email :</label
        >
      ...
      <div class="mr-10 flex justify-end">
        <button
            ...
            class="focus:outline-none text-white text-sm py-1 px-4 rounded-md bg-gradient-to-r from-blue-400 to-blue-600 transform hover:scale-110"
        >
          <svg
              class="h-5 w-5 "
              id="bold"
      ...
      <div class="block">
        ...
        >
          <div class="flex">
            <label class="m-3 w-2/4 text-left"
            >Mot de passe actuel
            </label>
...
export default {
  ...
  methods: {
    ...
    update_admin_password(){
      this.$store.dispatch("updateAdminPassword",this.admin_edit).then(res=>{
